...
WebAudio.Sound.prototype.magnitude = function(min, max)
{
	// inint variable
	var analyser	= this._analyser;
	var freqByte	= new Uint8Array(analyser.frequencyBinCount);
	...
	// complute the magnitude
	var magnitude	= sum / (max-min+1);
	// return magnitude
	return magnitude;
}

WebAudio.Sound.prototype.frequencyData	= function()
{
	// inint variable
	var analyser	= this._analyser;
	var freqByte	= new Uint8Array(analyser.frequencyBinCount);
